//Crie um algoritmo em Java que calcule a distância de Levenshtein entre duas Strings. A distância de Levenshtein
// é a quantidade mínima de edições de um único caractere (inserções, exclusões ou substituições) necessárias
// para mudar uma palavra para outra.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= m; i++) {
            ...
            for (int j = 1; j <= n; j++) {
                ...
                } else {                    int deletar = matrizDistancia[i - 1][j] + 1;
